...
var FirestoreDAO = class {
  ...
  subscribeToChanges(id, callback) {
    return new Subscription(onSnapshot(doc(this.collection, id), (doc2) => {
      callback(MGPOptional.ofNullable(doc2.data()));
    }));
  }
...
var AuthUser = class _AuthUser {
   ...
   */
  static NOT_CONNECTED = new _AuthUser("", MGPOptional.empty(), MGPOptional.empty(), false);
  /**
...
var ConnectedUserService = class ConnectedUserService2 {
      ...
      if (user == null) {
        ...
        this.userSubscription = this.userDAO.subscribeToChanges(user.uid, (docOpt) => {
          if (docOpt.isPresent()) {
            ...
            const authUser = new AuthUser(user.uid, MGPOptional.ofNullable(user.email), MGPOptional.ofNullable(username), userHasFinalizedVerification);
  ...
  registerAfterUsernameCheck(username, email, password) {
    return __async(this, null, function* () {
      try {
        ...
        const user = Utils.getNonNullable(userCredential.user);
  ...
  sendEmailVerification() {
    return __async(this, null, function* () {
      const user = MGPOptional.ofNullable(this.auth.currentUser);
      if (user.isPresent()) {
  ...
  doGoogleLogin() {
    return __async(this, null, function* () {
      return MGPValidation.ofFallible(yield this.registerOrLoginWithGoogle());
    });
  }
  ...
  setUsername(username) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const currentUser = Utils.getNonNullable(this.auth.currentUser);
...
@firebase/auth/dist/esm/index-568d0403.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2UAGI2IP.js.map
