...
var Fuse = class {
  ...
  _getSearcher(query) {
    ...
    const opts = this._invertedIndex ? __spreadProps(__spreadValues({}, this.options), {
...
Fuse.match = function(pattern, text, options) {
  const searcher = createSearcher(pattern, __spreadValues(__spreadValues({}, Config), options));
...
//# sourceMappingURL=chunk-YW53KUFG.js.map
