...
var BaseWrapperComponent = class extends BaseComponent {
  ...
  getGameUrlName() {
    return import_lib.Utils.getNonNullable(this.activatedRoute.snapshot.paramMap.get("game"));
  }
  getGameName() {
...
var GameWrapper = class _GameWrapper extends BaseWrapperComponent {
  ...
  gameComponent;
  players = [import_lib2.MGPOptional.empty(), import_lib2.MGPOptional.empty()];
  /**
  ...
  createGameComponent(component) {
    return __async(this, null, function* () {
      import_lib2.Utils.assert(this.boardRef != null, "Board element should be present");
      const componentRef = import_lib2.Utils.getNonNullable(this.boardRef()).createComponent(component);
  ...
  receiveValidMove(move) {
    return __async(this, null, function* () {
      ...
      if (legality.isFailure()) {
        ...
        return import_lib2.MGPValidation.ofFallible(legality);
      }
  ...
  canUserPlay(_clickedElementName) {
    return __async(this, null, function* () {
      if (this.isPlayerTurn() === false) {
        return import_lib2.MGPValidation.failure(GameWrapperMessages.NOT_YOUR_TURN());
      }
      if (this.endGame) {
        return import_lib2.MGPValidation.failure(GameWrapperMessages.GAME_HAS_ENDED());
      }
...
//# sourceMappingURL=chunk-AYR474CO.js.map
