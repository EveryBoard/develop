...
var Config = Object.freeze(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, BasicOptions), MatchOptions), FuzzyOptions), AdvancedOptions));
...
var FuseIndex = class {
  ...
  toJSON() {
    return {
      keys: this.keys.map((_a) => {
        var _b = _a, { getFn } = _b, key = __objRest(_b, ["getFn"]);
        return key;
      }),
...
var Fuse = class {
  ...
  _getSearcher(query) {
    ...
    const searcher = createSearcher(query, this._invertedIndex ? __spreadProps(__spreadValues({}, this.options), {
...
Fuse.match = function(pattern, text, options) {
  ...
  return createSearcher(pattern, __spreadValues(__spreadValues({}, Config), options)).searchIn(text);
};
...
function PickGameComponent_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "div", 4)(3, "p", 5);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 6)(6, "figure", 7)(7, "img", 8);
    \u0275\u0275listener("click", function PickGameComponent_For_3_Template_img_click_7_listener() {
      const game_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.selectGame(game_r2.urlName));
    });
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("id", \u0275\u0275interpolate1("image-", game_r2.urlName))("src", \u0275\u0275interpolate2("assets/images/", ctx_r2.theme, "/", game_r2.urlName, ".png"), \u0275\u0275sanitizeUrl);
  }
}
var PickGameComponent = class _PickGameComponent {
  ...
  search(input) {
    const searchTerm = this.normalize(input.value);
    if (searchTerm.length === 0) {
      this.matchingGames = this.games;
    } else {
      const fuse = new entry_default(this.games, {
        keys: ["name", "urlName"],
        ignoreLocation: true,
        threshold: 0.5
      });
      this.matchingGames = fuse.search(searchTerm).map((result) => result.item);
    }
  }
  normalize(term) {
    return term.toLowerCase().replace(/ /g, "").normalize("NFKD").replace(/[^\w]/g, "");
  }
  static \u0275fac = function PickGameComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PickGameComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PickGameComponent, selectors: [["app-pick-game"]], outputs: { pickGame: "pickGame" }, decls: 4, vars: 0, consts: () => {
    let i18n_0;
    if (false) {
    ...
    return [["id", "search-term", "placeholder", i18n_0, "autofocus", "", 1, "input", "is-fullwidth", "mb-4", "is-large", 3, "input"], [1, "columns", "is-multiline"], [1, "column", "is-one-fifth"], [1, "card", "mb-0"], [1, "card-header"], [1, "card-header-title"], [1, "card-image", "game-card"], [1, "image"], [1, "is-clickable", 3, "click", "id", "src"]];
  }, template: function PickGameComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "input", 0);
      \u0275\u0275listener("input", function PickGameComponent_Template_input_input_0_listener($event) {
        return ctx.search($event.target);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(1, "div", 1);
      \u0275\u0275repeaterCreate(2, PickGameComponent_For_3_Template, 8, 6, "div", 2, _forTrack0);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.matchingGames);
    }
  }, dependencies: [AutofocusDirective], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PickGameComponent, [{
    type: Component,
    args: [{ selector: "app-pick-game", imports: [AutofocusDirective], template: '<input id="search-term"\n       class="input is-fullwidth mb-4 is-large"\n       placeholder="Search game"\n       i18n-placeholder\n       (input)="search($event.target)"\n       autofocus/>\n<div class="columns is-multiline">\n    @for (game of matchingGames; track game.name) {\n        <div class="column is-one-fifth">\n            <div class="card mb-0">\n                <div class="card-header">\n                    <p class="card-header-title">{{ game.name }}</p>\n                </div>\n                <div class="card-image game-card">\n                    <figure class="image">\n                        <img id="image-{{ game.urlName }}"\n                             class="is-clickable"\n                             src="assets/images/{{ theme }}/{{ game.urlName }}.png"\n                             (click)="selectGame(game.urlName)"/>\n                    </figure>\n                </div>\n            </div>\n        </div>\n    }\n</div>\n' }]
  }], null, { pickGame: [{ type: Output, args: ["pickGame"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PickGameComponent, { className: "PickGameComponent", filePath: "src/app/components/normal-component/pick-game/pick-game.component.ts", lineNumber: 15 });
})();
