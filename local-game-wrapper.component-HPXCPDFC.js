import {
  ViewConfigComponent
} from "./chunk-DDZ7SGRR.js";
import {
  GameWrapper,
  RulesConfigUtils
} from "./chunk-XOIRVCTA.js";
import {
  AIStats,
  GameNodeStats,
  GameStatus,
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(3, 6);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_For_5_Template, 2, 5, "option", 29, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const player_r4 = \u0275\u0275nextContext().$implicit;
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(6, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(7, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_For_8_Template, 2, 5, "option", 29, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(9, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template, 6, 3, "div", 26);
    \u0275\u0275conditionalCreate(10, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_10_Template, 2, 4, "p", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275element(1, "br");
  }
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_For_2_Template, 2, 1, null, null, _forTrack0);
    \u0275\u0275text(3);
    \u0275\u0275element(4, "br");
    \u0275\u0275text(5);
    \u0275\u0275element(6, "br");
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(10, 2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_Template, 7, 2, "div", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
//# sourceMappingURL=local-game-wrapper.component-HPXCPDFC.js.map
