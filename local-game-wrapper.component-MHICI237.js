import {
  ViewConfigComponent
} from "./chunk-RXPPSLWL.js";
import {
  GameWrapper,
  RulesConfigUtils
} from "./chunk-LCO3Y5NP.js";
import {
  AIStats,
  AbstractMinimax,
  BoardValue,
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template_select_ngModelChange_1_listener($event) {
      ...
      const player_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r1.aiProfiles[player_r4.getValue()], $event) || (ctx_r1.aiProfiles[player_r4.getValue()] = $event);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("id", \u0275\u0275interpolate1("ai-profile-select-", player_r4.getValue()));
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.aiProfiles[player_r4.getValue()]);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.availableAIProfiles(player_r4.getValue()));
  }
}
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 26)(1, "select", 31);
    \u0275\u0275twoWayListener("ngModelChange", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_10_Template_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r8);
      const player_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("change", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_10_Template_select_change_1_listener() {
      \u0275\u0275restoreView(_r8);
      const player_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.updatePlayer(player_r4));
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.mustSelectAIProfile(player_r4.getValue()) ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.players[player_r4.getValue()].equalsValue("human") === false && ctx_r1.isAIProfileSelected(player_r4.getValue()) ? 10 : -1);
    \u0275\u0275advance();
...
var LocalGameWrapperComponent = (_a = class extends GameWrapper {
  ...
  resetInvalidAISelection(playerIndex) {
    ...
    const profileExists = this.availableAIProfiles(playerIndex).some((profile) => {
      return profile.id === this.aiProfiles[playerIndex];
    });
    if (profileExists === false) {
      this.aiProfiles[playerIndex] = "none";
      this.aiOptions[playerIndex] = "none";
    } else if (this.availableAIOptions(playerIndex).some((option) => {
      return option.name === this.aiOptions[playerIndex];
    }) === false) {
      this.aiOptions[playerIndex] = "none";
    }
  }
  mustSelectAIProfile(playerIndex) {
    return this.playerSelection[playerIndex] !== "human" && (this.playerSelection[playerIndex] !== "mcts" || this.availableAIProfiles(playerIndex).length > 1);
  }
  isAIProfileSelected(playerIndex) {
  ...
  getPlayerName(playerIndex) {
    ...
    const profile = this.availableAIProfiles(playerIndex).find((candidate) => {
  ...
  getAI(turn) {
    ...
    const strategy = this.playerSelection[playerIndex];
    if (strategy === "human") {
      return MGPOptional.empty();
    }
    const profileId = this.aiProfiles[playerIndex];
    const optionName = this.aiOptions[playerIndex];
    const options = MGPOptional.ofNullable(this.availableAIOptions(playerIndex).find((option) => option.name === optionName));
    if (options.isAbsent()) {
      return MGPOptional.empty();
    }
    switch (strategy) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocalGameWrapperComponent, { className: "LocalGameWrapperComponent", filePath: "src/app/components/wrapper-components/local-game-wrapper/local-game-wrapper.component.ts", lineNumber: 39 });
})();
export {
  LocalGameWrapperComponent
};
//# sourceMappingURL=local-game-wrapper.component-MHICI237.js.map
