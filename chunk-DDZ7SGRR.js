...
var RulesConfigurationComponent = class _RulesConfigurationComponent extends BaseWrapperComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RulesConfigurationComponent, selectors: [["app-rules-configuration"]], inputs: { rulesConfigDescription: [1, "rulesConfigDescription"], rulesConfigToDisplay: [1, "rulesConfigToDisplay"], editable: [1, "editable"] }, outputs: { editable: "editableChange", updateCallback: "updateCallback" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: () => {
    let i18n_0;
    if (false) {
...
function ViewConfigComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275property("rulesConfigDescription", ctx_r1.rulesConfigDescription())("rulesConfigToDisplay", ctx_r1.rulesConfig())("editable", false);
  }
}
...
//# sourceMappingURL=chunk-DDZ7SGRR.js.map
