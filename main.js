...
var routes = [
  ...
  { path: "play/:game/:id", loadComponent: () => import("./online-game-wrapper.component-WF5AU6UV.js").then((m) => m.OnlineGameWrapperComponent), canActivate: [ExclusiveOnlineGameGuard, VerifiedAccountGuard] },
