import {
  ConfigRoomService
} from "./chunk-PWJDEZGM.js";
import {
  GameService
} from "./chunk-RBHW64CQ.js";
import {
  ChatService
} from "./chunk-YQHFU4BF.js";
import {
  CurrentGameService
} from "./chunk-ZEX6FMD2.js";
import {
  environment
} from "./chunk-IVC6PB5E.js";
import {
  GameInfo,
  MessageDisplayer
...
var routes = [
  ...
  { path: "lobby", loadComponent: () => import("./lobby.component-BUYJDM3S.js").then((m) => m.LobbyComponent), canActivate: [VerifiedAccountGuard] },
  ...
  { path: "play", loadComponent: () => import("./online-game-selection.component-YK7WC72N.js").then((m) => m.OnlineGameSelectionComponent), canActivate: [ExclusiveOnlineGameGuard, VerifiedAccountGuard] },
  { path: "play/:game", loadComponent: () => import("./online-game-creation.component-7TZ6AREO.js").then((m) => m.OnlineGameCreationComponent), canActivate: [ExclusiveOnlineGameGuard, VerifiedAccountGuard] },
  { path: "play/:game/:id", loadComponent: () => import("./online-game-wrapper.component-S7QREDQR.js").then((m) => m.OnlineGameWrapperComponent), canActivate: [ExclusiveOnlineGameGuard, VerifiedAccountGuard] },
  { path: "local", loadComponent: () => import("./local-game-creation.component-GHKI7QKT.js").then((m) => m.LocalGameCreationComponent) },
  { path: "local/:game/config", loadComponent: () => import("./local-game-configuration.component-IY6DRZEO.js").then((m) => m.LocalGameConfigurationComponent) },
  { path: "local/:game", loadComponent: () => import("./local-game-wrapper.component-VTZBUSYT.js").then((m) => m.LocalGameWrapperComponent) },
  { path: "tutorial", loadComponent: () => import("./tutorial-game-creation.component-MIIRQF4S.js").then((m) => m.TutorialGameCreationComponent) },
  { path: "tutorial/:game", loadComponent: () => import("./tutorial-game-wrapper.component-WOLIXQJ3.js").then((m) => m.TutorialGameWrapperComponent) },
  { path: "", loadComponent: () => import("./welcome.component-2KXYLAXY.js").then((m) => m.WelcomeComponent) },
  { path: "demo", loadComponent: () => import("./demo-page.component-47AAWBMP.js").then((m) => m.DemoPageComponent) },
