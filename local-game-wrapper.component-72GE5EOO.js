...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_4_Conditional_1_Template, 2, 1, "p", 22);
    \u0275\u0275conditionalCreate(2, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_4_Conditional_2_Template, 2, 0, "p", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 25)(1, "select", 30);
    \u0275\u0275twoWayListener("ngModelChange", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r6);
      const player_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("change", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template_select_change_1_listener() {
      \u0275\u0275restoreView(_r6);
      const player_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275i18n(3, 6);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_For_5_Template, 2, 5, "option", 28, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const player_r4 = \u0275\u0275nextContext().$implicit;
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 18)(1, "p", 24);
    \u0275\u0275i18n(2, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 25)(4, "select", 26);
    \u0275\u0275listener("change", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Template_select_change_4_listener() {
      const player_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.updatePlayer(player_r4));
    });
    \u0275\u0275twoWayListener("ngModelChange", function LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Template_select_ngModelChange_4_listener($event) {
      const player_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275i18n(6, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(7, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_For_8_Template, 2, 5, "option", 28, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(9, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_9_Template, 6, 3, "div", 25);
    \u0275\u0275conditionalCreate(10, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Conditional_10_Template, 2, 4, "p", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ai_r11 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275textInterpolate1(" ", ai_r11.name + ": " + ai_r11.getInfo(ctx_r1.gameComponent.node, ctx_r1.gameComponent.config), " ");
  }
}
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_11_For_6_Template, 2, 1, null, null, _forTrack0);
    \u0275\u0275text(7);
    \u0275\u0275element(8, "br");
    \u0275\u0275text(9);
    \u0275\u0275element(10, "br");
...
function LocalGameWrapperComponent_Conditional_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(3, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_4_Template, 3, 2, "div", 17);
    \u0275\u0275repeaterCreate(5, LocalGameWrapperComponent_Conditional_0_Conditional_2_For_6_Template, 11, 8, "div", 18, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(7, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_7_Template, 2, 0, "button", 19);
    \u0275\u0275conditionalCreate(8, LocalGameWrapperComponent_Conditional_0_Conditional_2_Conditional_8_Template, 2, 0, "button", 20);
...
function LocalGameWrapperComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, LocalGameWrapperComponent_Conditional_0_Conditional_2_Template, 12, 8, "div", 11);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocalGameWrapperComponent, { className: "LocalGameWrapperComponent", filePath: "src/app/components/wrapper-components/local-game-wrapper/local-game-wrapper.component.ts", lineNumber: 30 });
})();
export {
  LocalGameWrapperComponent
};
//# sourceMappingURL=local-game-wrapper.component-72GE5EOO.js.map
