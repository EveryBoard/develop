...
var DemoCardWrapperComponent = class _DemoCardWrapperComponent extends GameWrapper {
    ...
    return __async(this, null, function* () {
      setTimeout(() => __async(this, null, function* () {
        ...
        if (demoNodeInfo.click.isPresent()) {
          ...
          const element = import_lib.Utils.getNonNullable(this.elementRef.nativeElement.querySelector(clickSelector));
  ...
  onLegalUserMove(_move, _scores) {
    return __async(this, null, function* () {
      import_lib.Utils.assert(false, "DemoCardWrapper should not call applyLegalMove, as it does no move");
    });
  }
  getPlayer() {
    return "no-player";
  ...
  canUserPlay(_clickedElementName) {
    return __async(this, null, function* () {
      if (this.gameComponentIsSetup) {
        return import_lib.MGPValidation.failure(TutorialGameWrapperMessages.THIS_IS_A_DEMO());
      } else {
...
//# sourceMappingURL=chunk-ZIWFU67T.js.map
