...
var TimerComponent = class TimerComponent2 {
  static {
    TimerComponent_1 = this;
  }
  ...
  static DANGER_TIME_EVEN = "has-background-danger has-text-white";
  static DANGER_TIME_ODD = "has-background-warning has-text-white";
  static PASSIVE_STYLE = "has-text-passive is-italic";
  static SAFE_TIME = "";
  ...
  static \u0275fac = function TimerComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || TimerComponent2)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: TimerComponent2, selectors: [["app-timer"]], inputs: { player: [1, "player"], debugName: [1, "debugName"], timeToAdd: [1, "timeToAdd"], dangerTimeLimit: [1, "dangerTimeLimit"], active: [1, "active"], canAddTime: [1, "canAddTime"] }, outputs: { outOfTimeAction: "outOfTimeAction", addTimeToOpponent: "addTimeToOpponent" }, decls: 6, vars: 9, consts: [[1, "level", "columns", "is-gapless", 3, "ngClass"], [1, "level-item", "column"], [1, "is-size-3", "has-text-weight-bold", "data-remaining-time", 3, "ngClass"], [1, "button", "is-medium", "data-add-time", "has-text-black", "my-2", 2, "width", "6em", 3, "click", "ngClass"], ["viewBox", "0 0 24 24", "fill", "none", "xmlns", "http://www.w3.org/2000/svg", 1, "svg-inline-fa"], ["d", "M21.9208 13.265C21.9731 12.8507 22 12.4285 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C12.4354 22 12.8643 21.9722 13.285 21.9182M12 6V12L15.7384 13.8692M19 22V16M16 19H22", "stroke", "#000000", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"]], template: function TimerComponent_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [NgClass, DecimalPipe], encapsulation: 2, changeDetection: 0 });
};
...
var OnlineGameWrapperComponent = class OnlineGameWrapperComponent2 extends GameWrapper {
  ...
  applyMove(move, triggerAnimation) {
    return __async(this, null, function* () {
      ...
      const nextNode = new GameNode(stateAfterMove, MGPOptional.of(oldNode), MGPOptional.of(move));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: OnlineGameWrapperComponent2, selectors: [["app-online-game-wrapper"]], viewQuery: function OnlineGameWrapperComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx.gameTimerComponents, _c0, 5)(ctx.moveTimerComponents, _c1, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
