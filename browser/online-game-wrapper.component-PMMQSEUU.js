...
} from "./chunk-MGFZ5RLG.js";
import "./chunk-5CIFRPWI.js";
import {
  RulesConfigurationComponent,
  ViewConfigComponent
} from "./chunk-56I6LHM2.js";
import {
...
import {
  ...
  GameType,
  Status
} from "./chunk-5QLITPVM.js";
import "./chunk-K32U3NEP.js";
...
var TimerComponent = (_a = class {
  ...
  setDuration(seconds) {
    import_lib.Utils.assert(this.started === false, "Should not set a timer that has already been started (" + this.debugName() + ")!");
    this.isSet = true;
    this.changeDuration(seconds);
  }
  changeDuration(seconds) {
    import_lib.Utils.assert(this.isPaused, "Should not change duration of a clock while it is running");
  ...
  start() {
    import_lib.Utils.assert(this.isSet, "Should not start a timer that has not been set!");
    import_lib.Utils.assert(this.started === false, "Should not start timer that has already been started (" + this.debugName() + ")");
    this.started = true;
    this.resume();
  }
  resume() {
    import_lib.Utils.assert(this.isPaused && this.started, "Should only resume timers that are started and paused!");
  ...
  pause() {
    ...
    import_lib.Utils.assert(this.started, "Should not pause not started timer (" + debugName + ")");
    import_lib.Utils.assert(this.isPaused === false, "Should not pause already paused timer (" + debugName + ")");
    this.clearTimeouts();
    this.isPaused = true;
    this.updateShownTime();
  }
  stop() {
    import_lib.Utils.assert(this.started, "Should only stop timer that are started!");
...
function GameCreationComponent_Conditional_0_Conditional_1_Conditional_12_For_12_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function GameCreationComponent_Conditional_0_Conditional_1_Conditional_12_For_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GameCreationComponent_Conditional_0_Conditional_1_Conditional_12_For_12_Template_tr_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.selectOpponent(candidate_r5));
    });
    \u0275\u0275elementStart(1, "td", 79);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 80);
    \u0275\u0275conditionalCreate(4, GameCreationComponent_Conditional_0_Conditional_1_Conditional_12_For_12_Conditional_4_Template, 2, 0, "button", 81);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const candidate_r5 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275property("id", \u0275\u0275interpolate1("presenceOf_", candidate_r5))("ngClass", ctx_r2.viewInfo.candidateClasses[candidate_r5]);
    \u0275\u0275advance();
    \u0275\u0275property("id", ctx_r2.viewInfo.chosenOpponent === candidate_r5 ? "selected_" + candidate_r5 : "candidate_" + candidate_r5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(candidate_r5);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.viewInfo.chosenOpponent !== candidate_r5 ? 4 : -1);
  }
}
function GameCreationComponent_Conditional_0_Conditional_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(11, GameCreationComponent_Conditional_0_Conditional_1_Conditional_12_For_12_Template, 5, 6, "tr", 77, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function GameCreationComponent_Conditional_0_Conditional_1_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62)(1, "div", 46)(2, "label", 82);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 46)(11, "label", 84);
    \u0275\u0275i18nStart(12, 25);
    \u0275\u0275element(13, "output");
...
function GameCreationComponent_Conditional_0_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("rulesConfigDescriptionOptional", ctx_r2.rulesConfigDescription())("editable", ctx_r2.viewInfo.canEditConfig || false);
    \u0275\u0275advance(4);
...
function GameCreationComponent_Conditional_0_Conditional_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18nEnd();
    \u0275\u0275elementEnd()();
    \u0275\u0275element(21, "app-rules-configuration", 87, 0);
    ...
    \u0275\u0275conditionalCreate(27, GameCreationComponent_Conditional_0_Conditional_2_Conditional_2_Conditional_27_Template, 1, 1, "app-demo-card", 89);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275i18nApply(18);
    \u0275\u0275advance();
    \u0275\u0275property("rulesConfigDescriptionOptional", ctx_r2.rulesConfigDescription())("editable", false)("rulesConfigToDisplay", ctx_r2.getRulesConfigToDisplay());
    \u0275\u0275advance(6);
...
function GameCreationComponent_Conditional_0_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "div", 90)(2, "div", 91)(3, "p");
    \u0275\u0275i18n(4, 36);
    \u0275\u0275elementEnd()();
...
var GameCreationComponent = class GameCreationComponent2 extends BaseWrapperComponent {
  ...
  rulesConfig = import_lib2.MGPOptional.empty();
  configDemo = void 0;
  ngOnInit() {
  ...
  checkInputs() {
    ...
    import_lib2.Utils.assert(user.isPresent(), "GameCreationComponent should not be called without connected user");
    import_lib2.Utils.assert(user.get() !== AuthUser.NOT_CONNECTED, "GameCreationComponent should not be created with an empty userName");
    import_lib2.Utils.assert(this.gameId() !== "", "GameCreationComponent should not be created with an empty gameId");
  }
  createForms() {
  ...
  joinAndSubscribeToConfigRoom() {
    return __async(this, null, function* () {
      this.configRoomSubscription = yield this.configRoomService.join(this.gameId(), (configRoom) => this.onConfigRoomUpdate(configRoom), () => this.onGameCancelled(), (candidate) => this.onCandidateJoined(candidate), (candidate) => this.onCandidateLeft(candidate), (error) => void this.onError(error));
    });
  }
  onError(error) {
    return __async(this, null, function* () {
  ...
  getForm(name) {
    return import_lib2.Utils.getNonNullable(this.configFormGroup.get(name));
  }
  subscribeToFormElements() {
    this.getForm("chosenOpponent").valueChanges.pipe(takeUntil(this.ngUnsubscribe)).subscribe((opponent) => {
      ...
      const status = import_lib2.Utils.getNonNullable(this.currentConfigRoom).status;
  ...
  updateViewInfo(configRoom) {
    ...
    this.viewInfo.candidates = this.candidates.map((candidate) => candidate.name);
  ...
  setDataForCreator(configRoom) {
    ...
    if (opponent == null || opponent === "") {
      ...
      const chosenOpponentIsCandidate = this.candidates.some((minimalUser) => {
  ...
  getUserFromName(username) {
    const user = this.candidates.find((c) => c.name === username);
    return import_lib2.Utils.getNonNullable(user);
  }
  changeConfig() {
    return __async(this, null, function* () {
  ...
  onConfigRoomUpdate(configRoom) {
    return __async(this, null, function* () {
      ...
      if (configRoom.rulesConfig !== null) {
        this.onRulesConfigUpdate(import_lib2.MGPOptional.of(configRoom.rulesConfig));
      }
      if (this.chosenOpponentJustLeft(oldConfigRoom, configRoom) && this.userIsCreator(configRoom)) {
        const userName = import_lib2.Utils.getNonNullable(oldConfigRoom?.chosenOpponent).name;
  ...
  onCandidateJoined(candidate) {
    ...
    this.updateViewInfo(import_lib2.Utils.getNonNullable(this.currentConfigRoom));
  }
  onCandidateLeft(candidate) {
  ...
  isGameStarted(configRoom) {
    import_lib2.Utils.assert(configRoom != null, "configRoom should not be null (isGameStarted)");
    const status = import_lib2.Utils.getNonNullable(configRoom).status;
    return status === Status.STARTED || status === Status.FINISHED;
  }
  onGameStarted() {
    const configRoom = import_lib2.Utils.getNonNullable(this.currentConfigRoom);
  ...
  setConfigDemo(config) {
    ...
    if (stateProvider.isPresent()) {
      const state = stateProvider.get()(import_lib2.MGPOptional.of(config));
      const node = new GameNode(state);
      this.configDemo = {
        click: import_lib2.MGPOptional.empty(),
  ...
  }, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, RangeValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, NgClass, RulesConfigurationComponent, DemoCardWrapperComponent, HumanDurationPipe], encapsulation: 2 });
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(GameCreationComponent, [{
    type: Component,
    args: [{ selector: "app-game-creation", imports: [ReactiveFormsModule, NgClass, RulesConfigurationComponent, DemoCardWrapperComponent, HumanDurationPipe], template: `@if (viewInfo) {
    <div>
                                                        ...
                                                        @for (candidate of viewInfo.candidates; track candidate) {
                                                            <tr id="presenceOf_{{ candidate }}"
                                                                ...
                                                                <td [id]="viewInfo.chosenOpponent === candidate ? ('selected_' + candidate) : ('candidate_' + candidate)"
                                                                    class="td">{{ candidate }}</td>
                                                                <td class="td">
                                                                    @if (viewInfo.chosenOpponent !== candidate) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GameCreationComponent, { className: "GameCreationComponent", filePath: "src/app/components/wrapper-components/game-creation/game-creation.component.ts", lineNumber: 60 });
})();
...
var OGWCRequestManagerService = class _OGWCRequestManagerService {
  ...
  requestAwaitingReply = import_lib3.MGPOptional.empty();
  lastDeniedRequest = import_lib3.MGPOptional.empty();
  forbiddenRequests = new import_lib3.Set();
  onGameStart() {
    this.requestAwaitingReply = import_lib3.MGPOptional.empty();
    this.lastDeniedRequest = import_lib3.MGPOptional.empty();
    this.forbiddenRequests = new import_lib3.Set();
  }
  onReceivedMove() {
    this.forbiddenRequests = new import_lib3.Set();
    this.lastDeniedRequest = import_lib3.MGPOptional.empty();
  ...
  onReceivedRequest(request) {
    import_lib3.Utils.assert(this.requestAwaitingReply.isAbsent(), "Should not receive two requests in a row!");
    this.requestAwaitingReply = import_lib3.MGPOptional.of(request);
    this.forbiddenRequests = new import_lib3.Set();
    this.lastDeniedRequest = import_lib3.MGPOptional.empty();
  }
  /**
    ...
    return __async(this, null, function* () {
      ...
      if (reply.accept) {
        ...
        if (reply.user.id !== user.id) {
          this.lastDeniedRequest = import_lib3.MGPOptional.of(reply.requestType);
  ...
  getUnrespondedRequestFrom(user) {
    if (this.requestAwaitingReply.isPresent() && this.requestAwaitingReply.get().user.id === user.id) {
      return import_lib3.MGPOptional.of(this.requestAwaitingReply.get().requestType);
    } else {
      return import_lib3.MGPOptional.empty();
    }
  }
  getCurrentRequest() {
...
var OGWCTimeManagerService = class _OGWCTimeManagerService {
  ...
  configRoom = import_lib4.MGPOptional.empty();
  // The players, as we need to map between minimal users and player values
  players = [import_lib4.MGPOptional.empty(), import_lib4.MGPOptional.empty()];
  ...
  lastMoveStart = import_lib4.MGPOptional.empty();
  ...
  onGameStart(configRoom, game, players) {
    this.configRoom = import_lib4.MGPOptional.of(configRoom);
    this.players = players;
    this.lastMoveStart = import_lib4.MGPOptional.of(game.beginning);
    this.gameEnd = false;
  ...
  onReceivedAction(action) {
    switch (action.action) {
      ...
      case "StartGame":
        break;
      default:
        import_lib4.Utils.expectToBe(action.action, "Sync");
        this.onSync();
        break;
    }
  }
  playerOfMinimalUser(user) {
    if (this.players[0].equalsValue(user)) {
      ...
      import_lib4.Utils.assert(this.players[1].equalsValue(user), "MinimalUser should match a player");
      return Player.ONE;
    }
  }
  onReceivedMove(move) {
    ...
    this.lastMoveStart = import_lib4.MGPOptional.of(moveTime);
...
function OnlineGameWrapperComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("gameStartNotification", function OnlineGameWrapperComponent_Conditional_0_Template_app_game_creation_gameStartNotification_0_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_4_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_4_Conditional_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 52);
    \u0275\u0275conditionalCreate(1, OnlineGameWrapperComponent_Conditional_1_Conditional_4_Conditional_4_Conditional_1_Template, 2, 0, "span", 53)(2, OnlineGameWrapperComponent_Conditional_1_Conditional_4_Conditional_4_Conditional_2_Template, 2, 1, "span", 54);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(3, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, OnlineGameWrapperComponent_Conditional_1_Conditional_4_Conditional_4_Template, 3, 1, "p", 52);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "p", 55);
    \u0275\u0275i18n(2, 8);
    \u0275\u0275elementEnd()();
  }
}
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275conditionalCreate(1, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Conditional_1_Template, 2, 0, "p", 56);
    \u0275\u0275conditionalCreate(2, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Conditional_2_Template, 2, 0, "p", 57);
    \u0275\u0275conditionalCreate(3, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Conditional_3_Template, 2, 0, "p", 58);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275conditionalCreate(1, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Conditional_1_Template, 2, 0, "p", 59);
    \u0275\u0275conditionalCreate(2, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Conditional_2_Template, 2, 0, "p", 60);
    \u0275\u0275conditionalCreate(3, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Conditional_3_Template, 2, 1, "p", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 59);
    \u0275\u0275i18n(1, 15);
    \u0275\u0275elementEnd();
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 60);
    \u0275\u0275i18n(1, 16);
    \u0275\u0275elementEnd();
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 61);
    \u0275\u0275i18n(1, 17);
    \u0275\u0275elementEnd();
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275conditionalCreate(1, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Conditional_1_Template, 2, 1, "p", 59);
    \u0275\u0275conditionalCreate(2, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Conditional_2_Template, 2, 0, "p", 60);
    \u0275\u0275conditionalCreate(3, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Conditional_3_Template, 2, 1, "p", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 62);
    \u0275\u0275i18n(1, 19);
    \u0275\u0275elementEnd();
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275conditionalCreate(1, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_5_Conditional_1_Template, 2, 0, "p", 62);
    \u0275\u0275conditionalCreate(2, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_5_Conditional_2_Template, 2, 1, "p", 62);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43);
    \u0275\u0275conditionalCreate(1, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_1_Template, 3, 0, "div");
    \u0275\u0275conditionalCreate(2, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_2_Template, 4, 3, "div");
    \u0275\u0275conditionalCreate(3, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_3_Template, 4, 3, "div");
    \u0275\u0275conditionalCreate(4, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_4_Template, 4, 3, "div");
    \u0275\u0275conditionalCreate(5, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Conditional_5_Template, 3, 2, "div");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 69);
    \u0275\u0275listener("click", function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_For_5_Template_button_click_0_listener() {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 66);
    \u0275\u0275listener("click", function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275i18n(3, 21);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_For_5_Template, 3, 5, "button", 68, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_1_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_1_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_0_Template, 6, 2)(1, OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_1_Template, 8, 2, "div", 63);
    \u0275\u0275conditionalCreate(2, OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_2_Template, 5, 2, "div", 64);
    \u0275\u0275conditionalCreate(3, OnlineGameWrapperComponent_Conditional_1_Conditional_20_Conditional_3_Template, 5, 2, "div", 65);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function OnlineGameWrapperComponent_Conditional_1_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
function OnlineGameWrapperComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, OnlineGameWrapperComponent_Conditional_1_Conditional_4_Template, 5, 5, "div", 32);
    \u0275\u0275elementStart(5, "div", 33);
    \u0275\u0275conditionalCreate(6, OnlineGameWrapperComponent_Conditional_1_Conditional_6_Template, 2, 1, "p", 34);
    \u0275\u0275conditionalCreate(7, OnlineGameWrapperComponent_Conditional_1_Conditional_7_Template, 2, 1, "p", 35);
    \u0275\u0275elementStart(8, "app-timer", 36, 0);
    \u0275\u0275listener("outOfTimeAction", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_outOfTimeAction_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.reachedOutOfTime(ctx_r1.Player.ZERO));
    })("addTimeToOpponent", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_addTimeToOpponent_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("outOfTimeAction", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_outOfTimeAction_10_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.reachedOutOfTime(ctx_r1.Player.ZERO));
    })("addTimeToOpponent", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_addTimeToOpponent_10_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(13, OnlineGameWrapperComponent_Conditional_1_Conditional_13_Template, 2, 1, "p", 39);
    \u0275\u0275conditionalCreate(14, OnlineGameWrapperComponent_Conditional_1_Conditional_14_Template, 2, 1, "p", 40);
    \u0275\u0275elementStart(15, "app-timer", 41, 2);
    \u0275\u0275listener("outOfTimeAction", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_outOfTimeAction_15_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.reachedOutOfTime(ctx_r1.Player.ONE));
    })("addTimeToOpponent", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_addTimeToOpponent_15_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addGameTime());
    });
    ...
    \u0275\u0275listener("outOfTimeAction", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_outOfTimeAction_17_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.reachedOutOfTime(ctx_r1.Player.ONE));
    })("addTimeToOpponent", function OnlineGameWrapperComponent_Conditional_1_Template_app_timer_addTimeToOpponent_17_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addMoveTime());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(19, OnlineGameWrapperComponent_Conditional_1_Conditional_19_Template, 6, 5, "div", 43);
    \u0275\u0275conditionalCreate(20, OnlineGameWrapperComponent_Conditional_1_Conditional_20_Template, 4, 3);
    \u0275\u0275conditionalCreate(21, OnlineGameWrapperComponent_Conditional_1_Conditional_21_Template, 2, 0, "button", 44);
    \u0275\u0275elementEnd()();
...
var OnlineGameWrapperComponent = class OnlineGameWrapperComponent2 extends GameWrapper {
  ...
  extractGameIdFromURL() {
    return import_lib5.Utils.getNonNullable(this.activatedRoute.snapshot.paramMap.get("id"));
  }
  isPlaying() {
  ...
  startGame(configRoom) {
    return __async(this, null, function* () {
      import_lib5.Utils.assert(this.gameStarted === false, "Should not start already started game");
      ...
      setTimeout(() => __async(this, null, function* () {
        ...
        import_lib5.Utils.assert(createdSuccessfully, "Game should be created successfully, otherwise game-creation would have redirected");
        import_lib5.Utils.assert(this.gameComponent !== null, "Game component should exist");
        this.gameComponent.config = import_lib5.MGPOptional.of(configRoom.rulesConfig);
  ...
  onGameStart() {
    return __async(this, null, function* () {
      ...
      import_lib5.Utils.assert(turn === 0, "turn should always be 0 upon game start");
      yield this.initializePlayersData();
      this.timeManager.onGameStart(this.configRoom, import_lib5.Utils.getNonNullable(this.game), this.players);
    ...
    return __async(this, null, function* () {
      ...
      switch (event.eventType) {
        ...
        case "Reply":
          ...
          break;
        default:
          import_lib5.Utils.expectToBe(event.eventType, "Action", "Event should be an action");
  ...
  takeBackToPreviousPlayerTurn(player) {
    return __async(this, null, function* () {
      ...
      if (this.gameComponent.getCurrentPlayer() !== player) {
        import_lib5.Utils.assert(this.gameComponent.getTurn() > 0, "Should not allow player that never moved to take back");
        this.gameComponent.node = this.gameComponent.node.parent.get();
      }
      yield this.setCurrentPlayerAccordingToCurrentTurn();
  ...
  canResign() {
    import_lib5.Utils.assert(this.isPlaying(), "Non playing should not call canResign");
    if (this.endGame) {
      return false;
    }
  ...
  requestAvailable(request) {
    switch (request) {
      ...
      default:
        import_lib5.Utils.expectToBe(request, "Rematch");
  ...
  getRequestAwaitingReplyFromUs() {
    import_lib5.Utils.assert(this.role.isPlayer(), "User should be playing");
    return this.requestManager.getUnrespondedRequestFrom(import_lib5.Utils.getNonNullable(this.opponent));
  }
  getRequestAwaitingReplyFromOpponent() {
    import_lib5.Utils.assert(this.role.isPlayer(), "User should be playing");
    return this.requestManager.getUnrespondedRequestFrom(import_lib5.Utils.getNonNullable(this.currentUser));
  }
  deniedRequest() {
    return this.requestManager.deniedRequest();
  }
  canPass() {
    import_lib5.Utils.assert(this.isPlaying(), "Non playing should not call canPass");
    if (this.endGame)
      return false;
  ...
  canAskTakeBack() {
    import_lib5.Utils.assert(this.isPlaying(), "Non playing should not call canAskTakeBack");
    import_lib5.Utils.assert(this.game != null, "should not call canAskTakeBack when game is not defined yet");
    if (this.endGame)
      return false;
  ...
  canProposeDraw() {
    import_lib5.Utils.assert(this.isPlaying(), "Non playing should not call canProposeDraw");
    if (this.endGame)
      return false;
  ...
  canUserPlay(clickedElementName) {
    return __async(this, null, function* () {
      if (this.role.isNone()) {
        ...
        return import_lib5.MGPValidation.failure(message);
      }
      ...
      if (result.isFailure()) {
        ...
        return import_lib5.MGPValidation.failure(OnlineGameWrapperMessages.MUST_ANSWER_REQUEST());
      } else {
        return import_lib5.MGPValidation.SUCCESS;
      }
    });
  }
  initializePlayersData() {
    return __async(this, null, function* () {
      const game = import_lib5.Utils.getNonNullable(this.game);
      this.players = [
        import_lib5.MGPOptional.of(game.playerZero),
        import_lib5.MGPOptional.ofNullable(game.playerOne)
      ];
      yield this.setCurrentPlayerAccordingToCurrentTurn();
  ...
  applyMove(move, triggerAnimation) {
    return __async(this, null, function* () {
      ...
      import_lib5.Utils.assert(legality.isSuccess(), "OGWC.applyMove called with an illegal move");
      const stateAfterMove = this.gameComponent.rules.applyLegalMove(move, state, config, legality.get());
      this.gameComponent.node = new GameNode(stateAfterMove, import_lib5.MGPOptional.of(oldNode), import_lib5.MGPOptional.of(move));
  ...
  propose(request) {
    return __async(this, null, function* () {
      import_lib5.Utils.assert(this.role.isPlayer(), "cannot propose request if not player");
      switch (request) {
        case "Rematch":
        ...
        default:
          import_lib5.Utils.expectToBe(request, "TakeBack");
  ...
  accept() {
    return __async(this, null, function* () {
      import_lib5.Utils.assert(this.role.isPlayer(), "cannot accept request if not player");
  ...
  reject() {
    return __async(this, null, function* () {
      import_lib5.Utils.assert(this.role.isPlayer(), "cannot reject request if not player");
      const request = this.requestManager.getCurrentRequest().get().requestType;
      switch (request) {
        case "Rematch":
  ...
  getConfig() {
    const rulesConfig = this.configRoom.rulesConfig;
    return import_lib5.MGPOptional.of(rulesConfig);
  }
  isAgreedDraw() {
    const result = import_lib5.Utils.getNonNullable(this.game).result;
  ...
  getDrawAccepter() {
    ...
    switch (result) {
      case "AgreedDrawByZero":
        return import_lib5.Utils.getNonNullable(this.game).playerZero;
      default:
        import_lib5.Utils.expectToBe(result, "AgreedDrawByOne");
        return import_lib5.Utils.getNonNullable(this.game).playerOne;
    }
  }
  isWin() {
    const result = import_lib5.Utils.getNonNullable(this.game).result;
  ...
  getWinner() {
    ...
    switch (result) {
      ...
      case "ResignOfZero":
        return import_lib5.Utils.getNonNullable(this.game).playerOne;
      default:
        import_lib5.Utils.expectToBeMultiple(result, ["VictoryOfZero", "TimeoutOfOne", "ResignOfOne"]);
        return import_lib5.Utils.getNonNullable(this.game).playerZero;
    }
  }
  getLoser() {
  ...
  }, features: [\u0275\u0275ProvidersFeature([OGWCTimeManagerService, OGWCRequestManagerService]), \u0275\u0275InheritDefinitionFeature], decls: 2, vars: 2, consts: () => {
    let i18n_0;
    if (false) {
                    ...
                    <div class="block player0-bg">
                        @if (players[0].isPresent()) {
                            <p id="playerZeroIndicator"
                               class="has-text-black player0-bg-darker is-size-5">{{ players[0].get().name }}</p>
                        }
                    ...
                    <div class="block player1-bg">
                        @if (players[1].isPresent()) {
                            <p id="playerOneIndicator"
                               class="has-text-black player1-bg-darker is-size-5">{{ players[1].get().name }}</p>
                        }
                        @if (game !== null && gameComponent && gameComponent.hasScores()) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OnlineGameWrapperComponent, { className: "OnlineGameWrapperComponent", filePath: "src/app/components/wrapper-components/online-game-wrapper/online-game-wrapper.component.ts", lineNumber: 49 });
})();
export {
  OnlineGameWrapperComponent,
  OnlineGameWrapperMessages
};
//# sourceMappingURL=online-game-wrapper.component-PMMQSEUU.js.map
