...
import "./chunk-56I6LHM2.js";
import "./chunk-JNEFX2J6.js";
import {
  GameInfo,
  GameNode
...
var DemoPageComponent = class _DemoPageComponent {
  ...
  getNodeFromStep(step, rules, defaultConfig, name) {
    ...
    const stepConfig = step.config.orElse(defaultConfig);
    if (step.hasSolution()) {
      ...
      if (typeof solution === "string") {
        return {
          ...
          config: stepConfig,
          click: import_lib.MGPOptional.of(solution),
          title: step.title,
          name
        };
      } else {
        ...
        const node = new GameNode(resultingState, import_lib.MGPOptional.of(parent), import_lib.MGPOptional.of(move));
        return {
          node,
          config: stepConfig,
...
//# sourceMappingURL=demo-page.component-6CJI355H.js.map
