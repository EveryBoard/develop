...
import "./chunk-6DPJ5FZV.js";
import "./chunk-VPL3GBHU.js";
import {
  Debug
} from "./chunk-6Q2SZNEY.js";
import "./chunk-VXIRSHDN.js";
import {
  require_dist
...
var ActiveConfigRoomsService = class _ActiveConfigRoomsService extends AbstractActiveConfigRoomsService {
  ...
  subscribe(callback) {
    const activeRooms = new import_lib.MGPMap();
...
function LobbyComponent_For_26_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function LobbyComponent_For_26_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function LobbyComponent_For_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(6, LobbyComponent_For_26_Conditional_6_Template, 1, 1)(7, LobbyComponent_For_26_Conditional_7_Template, 2, 0, "ng-container");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ctx_r2.getCreatorLine(configRoom_r2), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(configRoom_r2.chosenOpponent ? 6 : 7);
    \u0275\u0275advance(3);
...
var LobbyComponent = class LobbyComponent2 {
  ...
  backendService = inject(BackendService);
  activeConfigRooms = new import_lib2.MGPMap();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: LobbyComponent2, selectors: [["app-lobby"]], decls: 33, vars: 4, consts: () => {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(25, LobbyComponent_For_26_Template, 10, 8, "tr", 19, _forTrack0);
      \u0275\u0275elementEnd()()()();
  ...
  }, dependencies: [NgClass, OnlineGameSelectionComponent, ChatComponent], encapsulation: 2 });
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LobbyComponent, [{
    type: Component,
    args: [{ selector: "app-lobby", imports: [NgClass, OnlineGameSelectionComponent, ChatComponent], template: `<div class="tabs is-toggle is-fullwidth">
    <ul>
            ...
            <tbody>
                @for (configRoom of getActiveConfigRooms(); track configRoom.id; let i = $index) {
                    <tr id="part-{{ i }}"
                        ...
                        <td class="td"
                            id="part-of-{{ configRoom.creator.name}}">{{ getCreatorLine(configRoom) }} </td>
                        <td class="td">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LobbyComponent, { className: "LobbyComponent", filePath: "src/app/components/normal-component/lobby/lobby.component.ts", lineNumber: 31 });
})();
export {
  LobbyComponent
};
//# sourceMappingURL=lobby.component-DZVCTIIG.js.map
