...
function RulesConfigurationComponent_Conditional_0_For_19_Case_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", \u0275\u0275interpolate1("", configParameter_r5, "_enum_config_input"))("disabled", ctx_r1.isEditable() === false);
    \u0275\u0275advance();
...
function RulesConfigurationComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275property("disabled", ctx_r1.isEditable() === false);
    \u0275\u0275advance();
...
var RulesConfigurationComponent = class _RulesConfigurationComponent extends BaseWrapperComponent {
  ...
  checkInputs() {
    if (this.editable() === false) {
      import_lib.Utils.assert(this.rulesConfigToDisplay() !== void 0, "Config should be provided if RulesConfigurationComponent is not editable");
    }
  }
  getChosenConfigName() {
  ...
  ngOnInit() {
    ...
    if (this.isCustomisable()) {
      ...
      return this.updateCallback.emit(import_lib.MGPOptional.of({}));
    }
  }
  ...
  getRulesConfigDescriptionValue(name, defaultValue) {
    if (this.editable()) {
      ...
      const configuration = import_lib.Utils.getNonNullable(this.rulesConfigToDisplay());
  ...
  onUpdate() {
    ...
    for (const field of fieldNames) {
      if (this.isValid(field)) {
        ...
        this.updateCallback.emit(import_lib.MGPOptional.empty());
        return;
      }
    }
  ...
  checkForValidators(rulesConfig) {
    ...
    if (this.errorMessages.length > 0) {
      ...
      this.updateCallback.emit(import_lib.MGPOptional.of(rulesConfig));
    }
  }
  typeOfConfig(field) {
  ...
  setChosenConfig(configName) {
    ...
    if (this.chosenConfigName === "Custom") {
      ...
      this.updateCallback.emit(import_lib.MGPOptional.of(chosenConfig));
    }
  }
  isCustomisable() {
    if (this.rulesConfigDescriptionOptional().isAbsent()) {
      ...
      import_lib.Utils.assert(this.rulesConfigDescriptionOptional().get().getFields().length > 0, "If rulesConfigDescriptionOptional is present it should have fields !");
  ...
  getDefactoConfigName() {
    ...
    const matchingConfigs = defaultConfigs.filter((nameConfig) => {
      return (0, import_lib.comparableEquals)(nameConfig.config, currentConfig);
    });
...
//# sourceMappingURL=chunk-56I6LHM2.js.map
